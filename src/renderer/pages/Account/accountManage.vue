    ...
    <el-row type="flex" justify="center">
        <el-col :span="23"  class="content">
            ...
            <div class="table_container">
                <div>
                    <el-button type="text" @click="GetListByType(null)">全部</el-button>
                    <el-button type="text" @click="GetListByType(1)">运维人员</el-button>
                    <el-button type="text" @click="GetListByType(2)">售后人员</el-button>
                    <el-button type="text" @click="GetListByType(3)">物业人员</el-button>
                </div>
                <el-table
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button @click="handleClick(scope.row,scope.$index)" type="danger" size="mini">删除</el-button>
                    </template>
                    </el-table-column>
                </el-table>
                ...
                <el-form :model="form" v-if="form" size="small">
                    <el-form-item label="姓名" label-width="100px">
                        <el-input  v-model="form.a00102" auto-complete="off" style="width: 75%" :disabled="allow"></el-input>
                    </el-form-item>
                    <el-form-item label="工号" label-width="100px">
                         <p style="margin: 0;"><span class="el-icon-tickets"></span> {{form.a00106}}</p>
                    </el-form-item>
                    ...
                    <el-form-item label="密码" label-width="100px">
                        <el-input v-if="!allow && Permision.passVisible" type="password" v-model="form.a00104"  auto-complete="off" style="width: 75%;display: none"></el-input>
                        <el-input v-if="!allow && Permision.passVisible" type="password" v-model="form.a00104"  auto-complete="off" style="width: 75%"></el-input>
                        <el-input v-else  auto-complete="off" style="width: 75%" :disabled="true"></el-input>
                    </el-form-item>
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="edit()">确 定 修 改</el-button>
                </div>
                </el-dialog>
                <!---->
            </div>
...
<script>
    ...
    import { AccountList,deleteAccount,editAccount,SearchAccount,show } from '@/interface/getData'

    export default {
        name:'AccountManage',
        data(){
            return{
                accountData:null,   //所有账户数据
        ...
        methods:{
            ...
            async GetListByType(type){
                this.loading = true;
                const result = await AccountList({a00105:type});
            ...
            goSearch(){  // 查询 并 匹配结果
                var that = this;
                this.searchList = [];
                this.currentPage = 1; //会触发handle事件产生bug待修复
            ...
            openEdit(row,index){  //打开编辑信息页
                this.allow = this.setPermision(row.a00105);
